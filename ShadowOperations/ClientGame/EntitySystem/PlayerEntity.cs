...
namespace ShadowOperations.ClientGame.EntitySystem
{
    public class PlayerEntity: PhysicsEntity
    {
            ...
            base (tclient, true, true)
        {
            ...
            CanRotate = false;
            EID = -1;
            model = TheClient.Models.GetModel("players/prototype/model.obj");
        }
        ...
        public override void Tick()
        {
            ...
            bool fly = false;
            bool on_ground = TheClient.Collision.CuboidLineTrace(new Location(HalfSize.X, HalfSize.Y, 0.1f), GetPosition(), GetPosition() - new Location(0, 0, 0.1f), IgnoreThis).Hit;
