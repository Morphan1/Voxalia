...
void main(void)
{
	...
	norm1 += (boneTrans[int(BoneID[0])] * Weights[0]) * vec4(normal, 1.0);
	norm1 += (boneTrans[int(BoneID[1])] * Weights[1]) * vec4(normal, 1.0);
	norm1 += (boneTrans[int(BoneID[2])] * Weights[2]) * vec4(normal, 1.0);
	norm1 += (boneTrans[int(BoneID[3])] * Weights[3]) * vec4(normal, 1.0);
