...
namespace Voxalia.Shared
{
    ...
    public static class Colors
    {
        ...
        public static Color LIGHT_STROBE_GREEN = Color.FromArgb(1, 255, 0, 255);
        public static Color LIGHT_STROBE_BLUE = Color.FromArgb(1, 255, 255, 0);
        public static Color LIGHT_STROBE_RED = Color.FromArgb(1, 0, 255, 255);
        public static Color LIGHT_STROBE_MAGENTA = Color.FromArgb(1, 0, 255, 0);
        public static Color LIGHT_STROBE_YELLOW = Color.FromArgb(1, 0, 0, 255);
        public static Color LIGHT_STROBE_CYAN = Color.FromArgb(1, 255, 0, 0);
