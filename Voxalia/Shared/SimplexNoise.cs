...
namespace Voxalia.Shared
{
    ...
    public class SimplexNoiseInteral
    {
        ...
        private static long FastFloor(float x)
        {
        ...
        private static float grad(long hash, float x)
        {
            long h = hash & 15;
        ...
        private static float grad(long hash, float x, float y)
        {
        ...
        private static float grad(long hash, float x, float y, float z, float t)
        {
