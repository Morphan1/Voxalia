...
namespace Voxalia.ServerGame.EntitySystem
{
    public class PlayerEntity: EntityLiving
    {
            ...
            : base(tregion, true, 100f)
        {
            ...
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/sand", "Sand", "Literally, it's sand!", Color.White.ToArgb(), "items/block.dae", false) { Datum = (int)Material.SAND });
