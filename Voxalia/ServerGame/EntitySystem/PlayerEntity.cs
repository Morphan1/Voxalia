...
namespace Voxalia.ServerGame.EntitySystem
{
    public class PlayerEntity: CharacterEntity
    {
            ...
            : base(tregion, 100f)
        {
            ...
            Items.GiveItem(new ItemStack("rifle_gun", TheServer, 1, "items/weapons/rifle_ico", "Assault Rifle", "It shoots rapid-fire bullets!", Color.White, "items/weapons/m4a1", false));
