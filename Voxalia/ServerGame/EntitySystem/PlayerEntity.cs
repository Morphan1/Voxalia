...
namespace Voxalia.ServerGame.EntitySystem
{
    public class PlayerEntity: EntityLiving
    {
            ...
            : base(tregion, true, 100f)
        {
            ...
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/dirt", "Dirt", "Dirty!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.DIRT });
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/stone", "Stone", "Gets things stoned!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.STONE });
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/grass_side", "Grass", "Grassy!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.GRASS });
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/db_top", "DebugBlock", "Not buggy!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.DEBUG });
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/concrete", "Concrete", "Solid!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.CONCRETE });
            ...
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/wood", "Wood Log", "Makes a rather woody sound, doe'n'it?!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.LOG });
            ...
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/snow", "Snow", "Cold!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.SNOW });
            Items.GiveItem(new ItemStack("block", TheServer, 100, "blocks/solid/sand", "Sand", "Literally, it's sand!", Color.White.ToArgb(), "items/block", false) { Datum = (int)Material.SAND });
            ...
            Items.GiveItem(new ItemStack("rifle_gun", TheServer, 1, "items/weapons/minigun_ico", "Minigun", "It shoots ^ivery^r rapid-fire bullets!", Color.White.ToArgb(), "items/weapons/minigun", false,
            ...
            Items.GiveItem(new ItemStack("glowstick", TheServer, 10, "items/common/glowstick_ico", "Glowstick", "Pretty colors!", Color.Green.ToArgb(), "items/common/glowstick", false));
            SetHealth(Health);
