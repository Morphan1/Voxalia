...
namespace Voxalia.ClientGame.CommandSystem
{
    ...
    public class ClientCVar
    {
        ...
        public CVar r_fullscreen, r_width, r_height, r_antialiasing, r_vsync, r_lighting, r_renderwireframe,
            ...
            r_good_graphics, r_skybox, r_lensflare, r_texturelinear;
        ...
        public void Init(Outputter output)
        {
            ...
            r_texturelinear = Register("r_texturelinear", "false", CVarFlag.Boolean | CVarFlag.Delayed); // Whether textures are to use a linear blur or nearest-pixel mode.
            // Audio CVars
