...
namespace Voxalia.ClientGame.CommandSystem
{
    ...
    public class ClientCVar
    {
        ...
        public CVar r_fullscreen, r_width, r_height, r_vsync, r_lighting, r_renderwireframe,
            ...
            r_3d_enable, r_fast, r_chunksatonce;
        ...
        public void Init(Outputter output)
        {
            ...
            r_zfar = Register("r_zfar", "3000", CVarFlag.Numeric, "How far the far plane should be from the camera.");
            ...
            r_chunksatonce = Register("r_chunksatonce", "12", CVarFlag.Numeric, "How many chunks can render at once.");
            // Audio CVars
